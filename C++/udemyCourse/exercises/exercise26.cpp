...
In this exercise you will create a program that will be used to print the guest 
list to an event and then clear the guest list when the event is over.
...
The print_guest_list function should print the guest list in the order of guest_1, guest_2 , 
guest_3, with each entry being printed on a new line. For testing purposes, please ensure 
that a newline is printed after guest_3 either through the use of endl; or the newline character "\n". 
