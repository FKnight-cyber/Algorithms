...
of money that will be accumulated if you start with a penny and double it 
everyday for n number of days.
...
For this program, assume that all money will be represented as a double value and so a penny 
will be represented as 0.01.

Begin by completing the function prototype a_penny_doubled_everyday which is 
passed an int and a double.
...
Note: if you get an error such as "Oops, there was a problem on our end". 
This may mean that you have infinite recursion in your solution. 
Make sure your logic checks for a base case and doesn't recurse forever.
...
double a_penny_doubled_everyday(int days, double penny = 0.01);//----WRITE THE FUNCTION PARAMETER LIST WITHIN THE PARENTHESES
...
double a_penny_doubled_everyday(int days, double amount) {//----WRITE THE FUNCTION PARAMETER LIST WITHIN THE PARENTHESES
    ...
    return a_penny_doubled_everyday(days--, amount*2);  
